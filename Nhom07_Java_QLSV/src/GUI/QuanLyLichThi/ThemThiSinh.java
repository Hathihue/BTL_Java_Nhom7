...
public class ThemThiSinh extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tìm sinh viên theo mã");
    ...
    private void btnThemThiSinh1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemThiSinh1ActionPerformed
        ...
        if (selectedRows.length <= 0) {
            ...
            int confirm = JOptionPane.showConfirmDialog(this, "Thêm những sinh viên đã chọn", "Xác nhận thêm", JOptionPane.INFORMATION_MESSAGE);
            if (searchSV == null) {
